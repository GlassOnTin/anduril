...
// =============================================================================
// CCT Ramp Lookup Table - RGB values along Planckian locus (2700K to 6500K)
// Generated by tools/led_colorimetry.py using CIE 1931 colorimetry
//
// To regenerate this table:
//   python3 tools/led_colorimetry.py --config d4k-rgbg --cct-lut 2700 6500 16
//
// Index 0 = warm (2700K), Index 15 = cool (6500K)
