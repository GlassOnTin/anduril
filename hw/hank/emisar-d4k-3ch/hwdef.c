...
Channel channels[] = {
    ...
    { // CCT ramp mode: 2700K (warm) to 6500K (cool) along Planckian locus
        ...
        .has_args     = 1  // 3H adjusts color temperature
    },
    { // chaotic pendulum color animation
        .set_level    = set_level_chaos,
        .gradual_tick = gradual_tick_chaos,
        .has_args     = 1  // energy/speed parameter
    },
    RGB_AUX_CHANNELS
};

// HSV and chaos modes need different 3H handlers (circular wrap-around)
// CCT mode uses default linear 3H (warm to cool)
StatePtr channel_3H_modes[NUM_CHANNEL_MODES] = {
    NULL, NULL, NULL, NULL,
    NULL, NULL, circular_tint_3h, NULL, NULL, circular_tint_3h,  // HSV and chaos use circular 3H
};
